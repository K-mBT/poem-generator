...
function generatePoem(event) {
  ...
  let context =
    "You are german poet. You must generate a 5 line poem in basic HTML and separate each line with a <br />. Make sure to follow the user instructions. Do not include a title to the poem. Do not refer to HTML in your poem.";
